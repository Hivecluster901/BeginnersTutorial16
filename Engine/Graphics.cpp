...
void Graphics::DrawCircle(int centerX, int centerY, int radius, Color c)
{
	...
	for (int y_loop = centerY - radius; y_loop < centerY + radius + 1; y_loop++)
	{
		for (int x_loop = centerX - radius; x_loop < centerX + radius + 1; x_loop++)
		{
			const int x_diff = x_loop - centerX;
			const int y_diff = y_loop - centerY;
